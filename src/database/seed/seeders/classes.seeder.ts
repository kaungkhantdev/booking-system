    ...
    data.push(
      {
        ...
        start_time: moment.tz('Asia/Bangkok').add(1, 'month').format(),
        end_time: moment.tz('Asia/Bangkok').add(2, 'month').format(),
        credit: 20,
      ...
      },
      {
        ...
        start_time: moment.tz('Asia/Bangkok').clone().add(1, 'days').format(),
        end_time: moment.tz('Asia/Bangkok').clone().add(2, 'days').format(),
        credit: 10,
